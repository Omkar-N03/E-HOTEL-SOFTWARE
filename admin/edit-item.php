...
<main class="main-content">
    <div class="form-container">
        <header class="header-flex">
            ...
            <a href="manage-menu.php" style="color: var(--text-muted); text-decoration: none;"><i class="fa fa-times"></i> Close</a>
        </header>

        <?php if($message): ?>
            <p style="color: var(--danger); margin-bottom: 1rem;"><?php echo $message; ?></p>
        <?php endif; ?>
        ...
        <form method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <div class="image-preview-wrapper">
                    <?php if ($item['image_url']): ?>
                        <img src="../<?php echo $item['image_url']; ?>" alt="Dish Preview" class="current-img">
                        <div>
            ...
            <div class="form-group toggle-group">
                <input type="checkbox" name="is_available" id="available" <?php echo $item['is_available'] ? 'checked' : ''; ?> style="width: 18px; height: 18px;">
                <label for="available" style="margin-bottom: 0; color: #166534; cursor: pointer;">Dish is currently available for orders</label>
            </div>
